...
export var ChannelErrorName = /* @__PURE__ */ ((ChannelErrorName2) => {
...
export class ChannelErrors {
  static CreateReceiptDigestError({ metadata = {}, stack } = {}) {
  ...
  static CreateEventError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static SetPeerError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OpenRequestError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnOpenRequestedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static AcceptOpenError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static RejectOpenError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnOpenAcceptedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static ConfirmOpenError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OpenConfirmedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OpenRejectedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static CompleteOpenError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static CloseError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnClosedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnCloseConfirmedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static ConfirmCloseError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static CompleteCloseError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static CreateMessageDigestError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OpenMessageDigestError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static MessageSendingError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnMessageConfirmedError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static ConfirmMessageError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static GetEventMessageError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static CompleteMessageError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static HandleRequestError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static HandleResponseError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnMessageError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnCloseError({ metadata = {}, stack } = {}) {
    return new SparkError({
  ...
  static OnErrorError({ metadata = {}, stack } = {}) {
    return new SparkError({
