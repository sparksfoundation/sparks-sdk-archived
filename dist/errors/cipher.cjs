...
class CipherErrors {
  ...
  static GetCipherSecretKeyError({
    metadata = {},
    stack
  } = {}) {
    return new _SparkError.SparkError({
  ...
  static GetEncryptionKeypairError({
    metadata = {},
    stack
  } = {}) {
    return new _SparkError.SparkError({
  ...
  static SetEncryptionKeypairError({
    metadata = {},
    stack
  } = {}) {
    return new _SparkError.SparkError({
  ...
  static GenerateCipherKeyPairError({
    metadata = {},
    stack
  } = {}) {
    return new _SparkError.SparkError({
  ...
  static GenerateEncryptionSharedKeyError({
    metadata = {},
    stack
  } = {}) {
    return new _SparkError.SparkError({
...
exports.CipherErrors = CipherErrors;