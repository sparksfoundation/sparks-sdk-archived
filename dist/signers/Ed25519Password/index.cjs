...
var Ed25519Password_exports = {};
__export(Ed25519Password_exports, {
  Ed25519Password: () => Ed25519Password
});
module.exports = __toCommonJS(Ed25519Password_exports);
...
var Ed25519Password = class extends SparkSigner {
  ...
  async generateKeyPair({ password, salt: nonce }) {
    try {
      ...
      const keyPair = import_tweetnacl3.default.sign.keyPair.fromSeed(uint8Seed);
