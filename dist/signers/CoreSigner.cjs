...
class CoreSigner {
  ...
  getPublicKey() {
    try {
      ...
      throw _signer.SignerErrors.GetSignerPublicKeyError(error);
    }
  }
  getSecretKey() {
    try {
      ...
      throw _signer.SignerErrors.GetSignerSecretKeyError(error);
    }
  }
  getKeyPair() {
    try {
      ...
      throw _signer.SignerErrors.GetSignerKeyPairError(error);
    }
  }
  setKeyPair({
    publicKey,
    ...
    try {
      ...
      throw _signer.SignerErrors.SetSignerKeyPairError(error);
    }
  }
}
