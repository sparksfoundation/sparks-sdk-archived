import { CipherErrorFactory } from "../../errors/cipher.mjs";
import nacl from "tweetnacl";
import util from "tweetnacl-util";
import { parseJSON } from "../../common/index.mjs";
import { CipherAbstract } from "../../types/index.mjs";
...
export class X25519SalsaPoly extends CipherAbstract {
  ...
  async computeSharedKey(publicKey) {
    try {
      ...
      return errors.SharedKeyFailure(error.message);
    }
  }
  async encrypt({ data, publicKey, sharedKey }) {
    try {
      ...
      return errors.EncryptionFailure(error.message);
    }
  }
  async decrypt({ data, publicKey, sharedKey }) {
    try {
      ...
      return errors.DecryptionFailure(error.message);
    }
  }
}
