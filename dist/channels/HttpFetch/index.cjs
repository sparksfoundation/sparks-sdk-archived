...
var HttpFetch_exports = {};
__export(HttpFetch_exports, {
  HttpFetch: () => HttpFetch
});
module.exports = __toCommonJS(HttpFetch_exports);
...
function validCuid(id) {
  return (0, import_cuid2.isCuid)(id);
}
...
// src/channels/SparkChannel/index.ts
var SparkChannel = class extends import_eventemitter3.default {
  _spark;
  _channelId;
  _type;
  _peer;
...
// src/channels/HttpFetch/index.ts
var HttpFetch = class extends SparkChannel {
